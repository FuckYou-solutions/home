...
class _app {
  ...
  brandDescription = ['Bitch ass niggas', '.9yz coded this peice of shit', '"Harry.potta owns me" .9yz', 'Vulse is a porn addict', 'Nine Circles of Hell on TOP', 'the one and only'];
